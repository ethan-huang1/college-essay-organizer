...
export const prompts = pgTable(
  "prompts",
  {
    ...
    verificationStatus: text("verification_status", { enum: ["officially-verified", "corroborated", "previous-cycle", "no-supplement-confirmed", "needs-review", "manual"] }).notNull().default("manual"),
