...
export const caltech: SchoolSourceRecord = {
  ...
  note: "Caltech’s official page is explicitly labeled Fall 2027 and publishes the full structure: one academic-interest response, one of two Scholarly Character options, two of three Scientific Drive options, one community/fun response, and one optional academic-context response.",
  promptGroups: [
  ...
  prompts: [
    ...
    { externalRef: "optional-academic-context", title: "Optional Academic Context", promptText: "Caltech cares about context. Is there anything about your academic preparation, coursework, school context, or learning experiences that would help us better understand your readiness for Caltech?", requirement: "optional", note: "The source states no word or character limit." },
  ],
};
