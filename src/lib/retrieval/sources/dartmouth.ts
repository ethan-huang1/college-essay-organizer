...
export const dartmouth: SchoolSourceRecord = {
  ...
  promptGroups: [
    { key: "dartmouth-introduce", label: "Introduce yourself (choose one)", requiredCount: 1 },
    { key: "dartmouth-personal", label: "Personal response (choose one)", requiredCount: 1 },
  ],
  prompts: [
    ...
    { externalRef: "introduce-environment", title: "Your environment", promptText: "There is a Quaker saying: Let your life speak. Describe the environment in which you were raised and the impact it has had on the person you are today.", maxWordCount: 250, requirement: "optional", groupKey: "dartmouth-introduce" },
    { externalRef: "introduce-yourself", title: "Introduce yourself", promptText: "\"Be yourself,\" Oscar Wilde advised. \"Everyone else is taken.\" Introduce yourself.", maxWordCount: 250, requirement: "optional", groupKey: "dartmouth-introduce" },
    { externalRef: "personal-excitement", title: "What excites you?", promptText: "What excites you?", maxWordCount: 250, requirement: "optional", groupKey: "dartmouth-personal" },
    { externalRef: "personal-impact", title: "A life of purpose", promptText: "Labor leader and civil rights activist Dolores Huerta recommended a life of purpose. \"We must use our lives to make the world a better place to live, not just to acquire things,\" she said. \"That is what we are put on the earth for.\" In what ways do you hope to make—or are you already making—an impact? Why? How?", maxWordCount: 250, requirement: "optional", groupKey: "dartmouth-personal" },
    { externalRef: "personal-reading", title: "Insight from reading", promptText: "In an Instagram post, best-selling British author Matt Haig cheered the impact of reading. \"A good novel is the best invention humans have ever created for imagining other lives,\" he wrote. How have you experienced such insight from reading? What did you read and how did it alter the way you understand yourself and others?", maxWordCount: 250, requirement: "optional", groupKey: "dartmouth-personal" },
    { externalRef: "personal-dialogue", title: "Finding common ground", promptText: "The social and family interactions of wild chimpanzees have been the focus of Dame Jane Goodall's research for decades. Her understanding of animal behavior prompted the English primatologist to see a lesson for human communities as well: \"Change happens by listening and then starting a dialogue with the people who are doing something you don't believe is right.\" Channel Dame Goodall: Tell us about a moment when you engaged in a difficult conversation or encountered someone with an opinion or perspective that was different from your own. How did you find common ground?", maxWordCount: 250, requirement: "optional", groupKey: "dartmouth-personal" },
    { externalRef: "personal-nerdy-side", title: "Celebrate your nerdy side", promptText: "Celebrate your nerdy side.", maxWordCount: 250, requirement: "optional", groupKey: "dartmouth-personal" },
    { externalRef: "personal-difference", title: "Embracing difference", promptText: "\"It's not easy being green…\" was the frequent refrain of Kermit the Frog. How has difference been a part of your life, and how have you embraced it as part of your identity, outlook, or sense of purpose?", maxWordCount: 250, requirement: "optional", groupKey: "dartmouth-personal" },
  ],
};
