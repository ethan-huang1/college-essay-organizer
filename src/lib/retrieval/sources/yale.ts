...
// one of three" essay pool - encoded as a promptGroup so the app counts it as
// the one essay Yale actually asks for rather than three.
export const yale: SchoolSourceRecord = {
  ...
  note: "Official Yale Admissions \"Essay Topics\" page, explicitly labeled \"2026-2027.\" Answer exactly one of the three \"Choose One\" essays; the choice is the applicant's.",
  promptGroups: [{ key: "yale-choose-one", label: "Choose one essay", requiredCount: 1 }],
  prompts: [
