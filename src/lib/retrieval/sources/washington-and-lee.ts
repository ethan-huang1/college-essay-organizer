...
export const washingtonAndLee: SchoolSourceRecord = {
  ...
  promptGroups: [{ key: "wlu-johnson", label: "Johnson Scholarship (choose one)", requiredCount: 1 }],
  prompts: [
    {
    ...
    },
    {
      ...
      maxWordCount: 250,
      requirement: "optional",
      conditionalNote: "Applicants may answer one of four short-answer prompts, in 250 words or less or as a video of at most two minutes.",
    },
    {
    ...
    },
    {
      ...
      groupKey: "wlu-johnson",
      programKey: "johnson-scholarship",
      programLabel: "Johnson Scholarship",
    },
    {
